    ...
    return (
      <section className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "var(--color-bg)" }}>
        <div className="text-center space-y-4">
          ...
          <p style={{ color: "var(--color-text-secondary)" }}>Indlæser artikel…</p>
        </div>
      </section>
    );
  }
                ...
                {post.updated_at && post.updated_at !== post.created_at && (
                  <>
                    ...
                    <span className="text-sm" style={{ color: "var(--color-text-secondary)" }}>
                      Opdateret {formatDate(post.updated_at)}
                    </span>
                  </>
                )}
              </div>
            ...
            <aside className="lg:col-span-1 space-y-6">
              ...
              <div className="sticky top-24 space-y-6">
                  ...
                  return (
                    ...
                    >
                      {relCover ? (
                        ...
                        <div className="w-20 h-16 rounded-xl flex-shrink-0 flex items-center justify-center border-2"
                      ...
                      <div className="flex-1 min-w-0">
                        <h3
                          className="font-semibold text-sm leading-snug line-clamp-2 mb-1 transition-colors duration-300"
                          style={{ color: "var(--color-text)" }}
                        >
                          {rel.title}
                        </h3>
                ...
                <div className="rounded-2xl p-6 text-center"
                  style={{ backgroundColor: "var(--color-yellow)", color: "white" }}>
                  <h3 className="font-bold text-lg mb-2">Klar til at starte?</h3>
                  <p className="text-sm mb-4 opacity-90">
                    Bestil din første kørelek­tion i dag.
                  </p>
                  <Link
                    href="/kontakt"
