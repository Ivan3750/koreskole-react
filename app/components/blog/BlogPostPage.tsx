  ...
  useEffect(() => {
    ...
    const fetchPost = async () => {
      try {
        ...
        const res = await fetch(`${BASE_URL}/blog.php?id=${id}`, {
          credentials: "include",
        });

        if (!res.ok) {
          throw new Error("Artikel ikke fundet");
        }
        ...
        const allRes = await fetch(`${BASE_URL}/blog.php`, {
          credentials: "include",
        });
              ...
              <div className="sticky top-24 space-y-6">
                ...
                >
                  ...
                  <p className="text-sm mb-4 opacity-90">
                    Bestil din første kørelektion i dag.
                  </p>
