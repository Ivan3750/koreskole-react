      ...
      <div className="px-6">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="max-w-xl mx-auto lg:mx-0 order-2 lg:order-1 text-center lg:text-left">
            ...
            >
              <strong>Kørekort B</strong> er det klassiske bilkørekort i Danmark, 
              som giver dig ret til at køre almindelige personbiler. Det er den 
              mest populære kørekortskategori og din vej til frihed på vejene.
            </p>
              ...
              <div className="flex items-start gap-4 text-left">
                ...
                <div>
                  <h3 
                    ...
                    style={{ color: "var(--color-text)" }}
                  >
                    Kør personbiler op til 3.500 kg
                  </h3>
                  <p 
                    className="text-sm"
                    style={{ color: "var(--color-text-secondary)" }}
                  >
                    Med kørekort B må du føre almindelige biler med op til 8 passagersæder 
                    ud over førerens.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 text-left">
                ...
                <div>
                  ...
                  <p 
                    ...
                    style={{ color: "var(--color-text-secondary)" }}
                  >
                    Du kan trække en let påhængsvogn, så længe den samlede vægt 
            ...
            <p
              ...
              style={{ color: "var(--color-text-secondary)" }}
            >
              Hos <strong>Lønbæks Køreskole</strong> guider vi dig sikkert igennem 
              hele forløbet – fra teoriundervisning til den dag, du får dit kørekort 
              i hånden. Start din rejse mod kørekort B i dag!
            </p>
